...
- (void)setUI {
    ...
    /**
     默认是 选中第一行
     */
    MultilevelMenu * view=[[MultilevelMenu alloc] initWithFrame:CGRectMake(0, 64, self.view.frame.size.width, self.view.frame.size.height-64-44) WithData:lis withSelectIndex:^(NSInteger left, NSInteger right,rightMeun* info) {
